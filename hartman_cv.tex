...
Director of Q-step Programme \hfill {2017\,--\,}\\
Director of Learning and Teaching \hfill {2014\,--\,}\\
Lecturer in Quantitative Social Science \hfill {2014\,--\,}
\begin{innerlist}
...
Quantitative Marketing \& Communications Consultant  \hfill {2014\,--\,}
\begin{innerlist}
	\item[] Recent clients: Boots, Linney Group, McDonald's, \\ 
						Post Office, Royal Mail, Samworth Brothers, Tesco
\end{innerlist}
...
\begin{bibenum}
	\item Johnston, R., Pattie, C. J., {Hartman, T. K.}, Manley, D. J., 
		  Rossiter, D., \& Jones, K. {Scotland's electoral geography 
		  differed from the rest of Britain's in 2017 (and 2015) - 
		  Exploring its contours}. (Forthcoming). 
    ...
    \item Newman, B. J., \& {Hartman, T. K.} (Forthcoming).
          \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2900212}
	...
	\item Johnston, R, Rossiter, D., Manley, D. J., Pattie, C. J., 
		  {Hartman, T. K.}, \& Jones, K. (Forthcoming). {Coming full circle: 
		  The 2017 UK General Election and the changing electoral map}. 
		  \emph{The Geographical Journal}.\\
    ...
    \item Pattie, C. J., {Hartman, T. K.}, \& Johnston, R. (Forthcoming).
          ...
          \emph{British Journal of Politics \& International Relations}.\\
...
{Forecasting the 2017 General Election result by constituency: Evidence presented to the House of Lords Select Committee on Political Polling and Digital Media}. 
...
\item ``Knowing the margins: Campaigns and changing voter knowledge at the 2017 General Election in England'' with Ron Johnston and Charles Pattie.
...
\begin{longtable}{@{}p{3.5cm}@{}l}%
    \multicolumn{2}{l}{\textit{Conference Chair}}\\
            2017 ISPP & {Panel Sa7.3: The Psychology of Candidate 
            Perception and Evaluation}\\    
    
            2014 MPSA & {Panel 27-13: The Effects 
...
\emph{Quantitative Research Methods}
    \begin{innerlist}
        \item[] \href{https://www.futurelearn.com/courses/media-data}{Making Sense of Data in the Media} (MOOC)
    	\item[] Q-Step: Bayesian Data Analysis for the Social Sciences (UG)
    	\item[] Q-Step: Generalized Linear Models for the Social Sciences (UG)
    	\item[] Q-Step: Introductory Quantitative Data Analysis for the Social Sciences (UG)
        \item[] Research Methods I: Scope and Research Methods (PG)
        \item[] Research Methods II: Introduction to Quantitative Data Analysis (PG)
        \item[] Research Methods III: Advanced Quantitative Data Analysis (PG)
        \item[] Research Methods IV: Survey Construction and Experimental Design (PG)
        \item[] Structural Equation Modelling in R (short course for \href{https://www.aqmen.ac.uk/}{AQMeN})
    \end{innerlist}

\halfblankline

\emph{Political Behavior / Political Communication}
    \begin{innerlist}
...
\emph{Experiential Learning (Intensive On-Site Courses)}
    \begin{innerlist}
        \item[] Washington, D.C. (UG)
        \item[] New York City (UG)
    \end{innerlist}
...
\section{Academic\\ Service}
    \emph{at The University of Sheffield}
        \begin{innerlist}
        \item[] Director, Q-Step Programme, 2017--
        \item[] Director, Learning \& Teaching, 2014--
        \item[] Administrator, Research Ethics, 2014--
        ...
        \item[] Member, Governance and Participation Research Group, 2014--
        \end{innerlist}
...
%
%	``\href{http://www.wnyc.org/story/8888-rescue-bailout-speaking-metaphorically-about-financial-problems/}{`Rescue?' `Bailout?' Speaking Metaphorically About Financial Problems}.'' Radio interview
%	with John Hockenberry and Adaora Udoji from ``The Takeaway,'' WNYC Radio (NPR) and Public 
%	Radio International, October 1, 2008.

%\blankline

%	``\href{http://wcpn.ideastream.org/news/beyond-horse-race-why-politicians-love-metaphors}{Beyond the Horse %Race: Why Politicians Love Metaphors}.'' Radio interview with Eric Wellman, 
%	90.3 WCPN Ideastream (NPR), September 8, 2008.
%________________________________________________________________________________________
...
%``Exploring Political Psychology: Studies on Attitudes toward Hispanic Immigration,'' Appalachian Lifelong Learning Summer Program, Appalachian State University, August 25, 2011.

%\blankline

%``Getting Dirty: The Role of Negative Campaigning,'' Presidential Election Series Lecture, Appalachian State University, October 28, 2008.
...
McDonald's McCafe Project \hfill {2017}
\begin{innerlist}
	\item[] Designed market research survey (\textit{N} = 4,000) to assess 
	consumer preferences toward coffee consumption, including several 
	discrete choice experiments. Quantitative data analysis:   
	descriptive statistics by market segmentation, cluster analysis, and conjoint analysis.
\end{innerlist}

\halfblankline

Tesco Projects \hfill {2016\,--\,2017}
\begin{innerlist}
	\item[] Designed and analyzed consumer preference surveys and conjoint experiments 
	for a range of product offerings.
\end{innerlist}

\halfblankline

Chartered Institute of Procurement \& Supply Project \hfill {2016}
\begin{innerlist}
	\item[] Designed and analyzed market demand survey among multiple audiences.
\end{innerlist}

\halfblankline

Walker's Project \hfill {2016}
\begin{innerlist}
	\item[] Designed and analyzed consumer preference survey for product offerings.
\end{innerlist}

\halfblankline

Royal Mail \hfill {2016}
\begin{innerlist}
	\item[] Analyzed annual employee surveys ((\textit{N} = 120,000).
\end{innerlist}

\halfblankline

Post Office Communication Channels Project \hfill {2014\,--\,2015}
\begin{innerlist}
	\item[] Designed and analyzed employee survey to assess internal communication preferences.
	Quantitative data analysis: descriptive statistics, cluster analysis, regression modelling.
\end{innerlist}
